...
class TestReadDataFromFile(unittest.TestCase):
    ...
    """
    @patch("white_box.mockup_exercises.open", new_callable=mock_open, read_data="Hello, world!")
    def test_read_data_success(self, mock_file):
        ...
        mock_file.assert_called_once_with("fakefile.txt", encoding="utf-8") #verificar que el archivo se abrio con open correctamente
